...
const XPowerBy = () => {
  return (
    <a className='inline-flex items-center pr-3 space-x-3' href='https://mlchain.github.io/' target='_blank'>
      <span className='uppercase text-xs text-gray-400'>power by</span>
      <Image src='/logo.png' alt='Mlchain.AI Logo' width={48} height={20} priority />
    </a>
  )
}
...
export const XPowerByPrivacy = () => {
  return (
    <div className='flex items-center justify-center space-x-1 text-xs text-gray-400'>
      ...
      <a href='https://mlchain.github.io/privacy' target='_blank' className='underline inline-flex shrink-0'>
        privacy policy
      </a>
